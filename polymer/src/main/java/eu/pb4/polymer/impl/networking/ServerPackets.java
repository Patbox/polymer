...
public class ServerPackets {
    ...
    public static final Identifier SYNC_ITEM_GROUP_DEFINE_ID = id(SYNC_ITEM_GROUP_DEFINE);
    ...
    public static final Identifier SYNC_ITEM_GROUP_CONTENTS_ADD_ID = id(SYNC_ITEM_GROUP_CONTENTS_ADD);
    public static final String SYNC_ITEM_GROUP_CONTENTS_CLEAR = "sync/item_group/contents/clear";
    public static final Identifier SYNC_ITEM_GROUP_CONTENTS_CLEAR_ID = id(SYNC_ITEM_GROUP_CONTENTS_CLEAR);
    ...
    public static final Identifier SYNC_ITEM_GROUP_APPLY_UPDATE_ID = id(SYNC_ITEM_GROUP_APPLY_UPDATE);
