...
*Baker's Tools* adds a handful of new tools to the game, with custom textures and features, while still remaining 100% serverside!
...
It supports animations, Molang expressions, and various Blockbench features.

### Links:
- GitHub: https://github.com/tomalbrc/blockbench-import-library
...
## danse (1.21 / latest)
*danse* adds server-side player gestures using a resource pack. No client-side mods required!

### Links:
- GitHub: https://github.com/tomalbrc/danse
- Modrinth: https://modrinth.com/mod/danse
...
## Dust (1.21 / latest)
*Dust* adds dust and several ways to deal with said dust.

### Links:
- GitHub: https://github.com/Gibatron/dust
...
## filament (1.21 / latest)
*filament* is a library for creating data-driven Blocks, Items, and Decorations for Fabric-based servers. No client mods required!
...
## OvenLib (1.21 / latest)
*OvenLib* is primarily a helper library for developers looking to use Polymer.

### Links:
- GitHub: https://github.com/Polymerized-Bakery/OvenLib
- Modrinth: https://modrinth.com/mod/ovenlib
...
### Links:
- GitHub: https://github.com/Patbox/serveruifix
- Modrinth: https://modrinth.com/mod/server-ui-fix
...
### Links:
- Source: https://git.brn.systems/BRNSystems/Televator
- Modrinth: https://modrinth.com/mod/televator


## Toms Mobs (1.21 / latest)
*Toms Mobs* adds a small collection of server side mobs. No client mods required!

### Links:
- GitHub: https://github.com/tomalbrc/toms-mobs
- Modrinth: https://modrinth.com/mod/toms-mobs


## Toms Server Additions: Concrete! (1.21 / latest)
*TSA: Concrete!* adds new concrete brick blocks to your minecraft server, no client-side mods required!
...
## Toms Server Additions: Planks! (1.21 / latest)
...
## Toms Server Additions: Stone! (1.21 / latest)
*TSA: Stone!* adds a small collection of new stone blocks like Granite Bricks, Diorite Bricks, Polished Dripstone and more!
...
it is including Danmaku magic, farming, cooking and enchanting etc..
### Links
