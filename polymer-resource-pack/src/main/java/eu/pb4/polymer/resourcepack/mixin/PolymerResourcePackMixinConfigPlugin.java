...
public class PolymerResourcePackMixinConfigPlugin implements IMixinConfigPlugin {
    private static final String PACKAGE_ROOT = "eu.pb4.polymer.resourcepack.mixin.";
