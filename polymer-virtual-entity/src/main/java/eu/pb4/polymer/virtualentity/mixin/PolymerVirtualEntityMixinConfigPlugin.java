...
public class PolymerVirtualEntityMixinConfigPlugin implements IMixinConfigPlugin {
    private static final String PACKAGE_ROOT = "eu.pb4.polymer.virtualentity.mixin.";
