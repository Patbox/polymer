...
public record PolymerTagEntry(Identifier registry, List<TagData> tags) implements WritableEntry {
    ...
    public static PolymerTagEntry read(PacketByteBuf buf, int version) {
