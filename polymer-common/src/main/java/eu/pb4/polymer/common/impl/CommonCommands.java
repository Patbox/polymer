...
public class CommonCommands {
    public static final List<Consumer<LiteralArgumentBuilder<ServerCommandSource>>> COMMANDS_DEV = new ArrayList<>();
    public static final List<Consumer<LiteralArgumentBuilder<ServerCommandSource>>> COMMANDS = new ArrayList<>();
    ...
    static {
        ...
        try {
            ...
            aboutBasic.add(Text.of(CommonImpl.DESCRIPTION));
